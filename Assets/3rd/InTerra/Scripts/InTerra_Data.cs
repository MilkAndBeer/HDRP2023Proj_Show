...
namespace InTerra
{
	...
	{
		//------------------------------------------------------------------
		public const string HDRPObjectShaderTestName001 = "Shader Graphs/InTerra/HDRP/ObjectIntoTerrainIntergrationTest001";
		public const string HDRPObjectShaderTestName002 = "Shader Graphs/InTerra/HDRP/ObjectIntoTerrainIntergrationTest002";
		//------------------------------------------------------------------
		...
		public static bool CheckObjectShader(Material mat)
		{
			...
			&& (mat.shader.name == ObjectShaderName
			 ...
			 || mat.shader.name == HDRPObjectShaderTestName001  //##Test Shader Add
			 || mat.shader.name == HDRPObjectShaderTestName002 //##Test Shader Add
