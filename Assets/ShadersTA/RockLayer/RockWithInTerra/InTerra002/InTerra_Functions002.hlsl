...
#if defined (_TERRAIN_TRIPLANAR_ONE)  || defined (_TERRAIN_TRIPLANAR) || defined(_OBJECT_TRIPLANAR)
    #define TRIPLANAR
#endif
    ...
    #include "InTerra_LayersDeclaration002.hlsl"
    ...
    float4 RemapMasks(float4 mask, float4 remapScale, float4 remapOffset)
    {
            ...
            mask.rb = mask.rb * remapScale.gb + remapOffset.gb;
            return mask;
        #else
