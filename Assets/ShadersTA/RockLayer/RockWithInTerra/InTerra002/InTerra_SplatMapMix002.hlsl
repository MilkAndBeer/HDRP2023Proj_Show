...
#endif
{
    ...
    float3 wTangent;
    float3 wBTangent;
    #include "InTerra_SplatMapControl002.hlsl"
    ...
    //=======================================================================================
        ...
        float objectMetallic = baseMaskMap.r;
        float objectAo = baseMaskMap.g;
        ...
        float3 mainNorm = baseNormal;//UnpackNormalScale(SAMPLE_TEXTURE2D(_NormalMap, sampler_NormalMap, mainUV), _NormalScale);

        // avoid risk of NaN when normalizing.
        mainNorm.z += 1e-5f;

        float4 objectAlbedo = float4(baseColor, baseMaskMap.a);
